...
import 'package:livework_view/pages/emergency_contacts_page.dart';
import 'package:livework_view/pages/fire_extinguisher_usage_page.dart';
import 'package:livework_view/pages/first_aid_guide_page.dart';
import 'package:livework_view/pages/inspections_page.dart';
import 'package:livework_view/pages/report_hazards_page.dart';
import 'package:livework_view/pages/safety_guide_page.dart';
...
// SIMPLEST VERSION - JUST RED DOT ON ICON:
  ...
  // Remove the old _showEmergencyContacts method and replace it with:
  ...
  // Remove the old _showSafetyGuide method and replace it with:
  ...
  // Remove the old _showFirstAidGuide method and replace it with:
  ...
  void _showFirstAidGuide(BuildContext context) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const FirstAidGuidePage(),
      ),
    );
  }
  ...
  void _showDailyInspections(BuildContext context) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const InspectionsPage(),
      ),
    );
  }
